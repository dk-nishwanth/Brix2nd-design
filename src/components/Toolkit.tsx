...
const defaultFeatures: ToolkitFeature[] = [
  ...
  },
  {
    ...
    description: 'AWS, Azure, Cisco, CISSP, ITIL, PMP and vendor neutral certification programs.',
    colSpan: 4,
  ...
  },
  {
    ...
    description: 'ITIL, CISSP, CISA, CISM, PMP, JIRA Project Management, and certified IT management programs.',
    colSpan: 4,
    category: 'compliance',
  },
  {
    ...
    description: 'Infosec, VA/PT, mobile security scanning, baseline auditing, and IT infrastructure auditing.',
    colSpan: 4,
    category: 'services',
  },
  {
    ...
    description: 'Fostering programs on leadership, management, coaching, business skills, and behavioral development.',
    colSpan: 4,
    category: 'services',
  },
  {
    ...
    description: 'Partnered with world\'s leading OEMs as Authorised Training Partner & Learning Center.',
    colSpan: 4,
    category: 'services',
    badge: 'FEATURED',
    badgeColor: 'blue',
